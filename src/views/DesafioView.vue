...
.page { --text:#f4eee1;--text-soft:#b7ab98;--text-faint:#9c9080;--cyan:#7fc9bb;--gold:#d3a24f;--success:#93bf78;--danger:#e0846a;--border:rgba(168,150,120,0.15);--shadow:0 20px 48px rgba(0,0,0,0.38);
  font-family:'Inter',sans-serif;min-height:100vh;background:radial-gradient(ellipse at top left,rgba(211,162,79,0.08),transparent 30%),linear-gradient(180deg,#12100c,#1a160f);color:var(--text);line-height:1.6; }
...
.hero { background:linear-gradient(135deg,rgba(211,162,79,0.08),rgba(224,132,106,0.04)),linear-gradient(180deg,rgba(27,23,17,0.96),rgba(15,13,9,0.99));border:1px solid rgba(211,162,79,0.2);border-radius:24px;padding:28px;margin-bottom:18px;box-shadow:var(--shadow); }
.eyebrow { display:inline-flex;align-items:center;gap:7px;padding:5px 11px;border-radius:999px;background:rgba(211,162,79,0.1);border:1px solid rgba(211,162,79,0.2);color:#d3a24f;font-size:10px;font-weight:700;letter-spacing:.13em;text-transform:uppercase;margin-bottom:12px; }
.eyebrow::before { content:'';width:6px;height:6px;border-radius:999px;background:#d3a24f;box-shadow:0 0 8px rgba(211,162,79,0.55); }
...
.timer { font-family:'JetBrains Mono',monospace;font-size:13px;color:#d3a24f;margin-top:10px; }
...
.curso-btn.ativo { background:rgba(211,162,79,0.1);border-color:rgba(211,162,79,0.25);color:#d3a24f; }
.btn-aceitar { display:block;width:100%;padding:16px;border-radius:14px;border:none;background:linear-gradient(135deg,#d3a24f,#d3a24f);color:#1c150c;font-family:'Inter',sans-serif;font-size:13px;font-weight:800;letter-spacing:.07em;text-transform:uppercase;cursor:pointer;transition:transform .18s,box-shadow .18s;margin-top:8px;text-align:center;text-decoration:none; }
.btn-aceitar:hover { transform:translateY(-1px);box-shadow:0 12px 24px rgba(211,162,79,0.25); }
